...
sed -e s/\${ELIXIR_VERSION}/${ELIXIR_VERSION}/g Dockerfile.phoenix | sed -e s/\${ERLANG_VERSION}/${ERLANG_VERSION}/ > build/Dockerfile.phoenix
...
sed -e s/\${ELIXIR_VERSION}/hipe-${ELIXIR_VERSION}/g Dockerfile.phoenix | sed -e s/\${ERLANG_VERSION}/${ERLANG_VERSION}/ > build/Dockerfile.phoenix-hipe
